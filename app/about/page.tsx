    ...
    <div className="flex flex-col">
      ...
      <section className="bg-primary pt-24 sm:pt-32 pb-12 sm:pb-20 text-center">
        <div className="section-container">
          ...
          <p className="mx-auto max-w-4xl text-lg text-white leading-relaxed">
      ...
      <section className="py-12 sm:py-20 lg:py-32">
        <div className="section-container">
          <div className="grid gap-8 md:grid-cols-2">
            <Card className="bg-white border-secondary/20 p-5 sm:p-8 lg:p-10 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:border-secondary/50 hover:shadow-[0_10px_40px_rgba(42,157,143,0.25)] relative overflow-hidden group">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {VALUES.map((value) => {
              ...
              return (
                <Card 
                  key={value.title} 
                  className="bg-white border-secondary/20 p-5 sm:p-8 text-center shadow-lg transition-all duration-500 hover:-translate-y-2 hover:border-secondary/50 hover:shadow-[0_10px_40px_rgba(42,157,143,0.25)]"
                >
